    ...
    return ChangeNotifierProvider<UserViewModel>.value(
      ...
      child: Consumer<UserViewModel>(
        builder: (context, vm, _) {
          ...
          final currentUserIndex = filtered.indexWhere(
          ...
          final paginatedUsers =
              filtered.skip(startIndex).take(rowsPerPage).toList();

          // 👤 Always show current user on top of page 1
          if (currentPage == 0) {
            final currentUserIndex = paginatedUsers.indexWhere(
              (u) => u.userId == UserSession.uid,
            );
            if (currentUserIndex > 0) {
                          ...
                          children: [
                            ...
                            SingleChildScrollView(
                              ...
                              child: DataTable(
                                ...
                                rows:
                                    [
                                      ...paginatedUsers.where(
                                        (user) =>
                                            user.userId == UserSession.uid,
                                      ),
                                      ...paginatedUsers.where(
                                        (user) =>
                                            user.userId != UserSession.uid,
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  'Showing ${paginatedUsers.length} of $totalUsers',
                                ),
                                Row(
                                  children: [
                                    IconButton(
